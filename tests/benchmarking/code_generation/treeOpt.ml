...
let _effect_max_96 (_m_97 : int) =
  ...
  in
  let rec _find_max_133 _x_118 (_k_136 : int -> int) =
    match _x_118 with
    | Empty -> _k_136 0
    | Node (Empty, _x_126, Empty) -> _k_136 _x_126
    | Node (_left_129, _x_128, _right_127) ->
        let _l_119 (_y_130 : bool) =
          match _y_130 with
          | true ->
              _find_max_133 _left_129 (fun (_next_131 : int) ->
                  _k_136 (_x_128 + _next_131))
          | false ->
              _find_max_133 _right_127 (fun (_next_131 : int) ->
                  _k_136 (_x_128 + _next_131))
        in
