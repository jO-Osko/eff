...
let _bigTest_76 (_num_77 : int) =
  ...
  in
  let rec _interp_136 _x_108 (_k_139 : int -> int) =
    match _x_108 with
    | Num _b_114 -> _k_139 _b_114
    | Add (_l_116, _r_115) ->
        _interp_136 _l_116 (fun (_x_117 : int) ->
            _interp_136 _r_115 (fun (_y_118 : int) -> _k_139 (_x_117 + _y_118)))
    | Mul (_l_121, _r_120) ->
        _interp_136 _l_121 (fun (_x_122 : int) ->
            _interp_136 _r_120 (fun (_y_123 : int) -> _k_139 (_x_122 * _y_123)))
    | Sub (_l_126, _r_125) ->
        _interp_136 _l_126 (fun (_x_127 : int) ->
            _interp_136 _r_125 (fun (_y_128 : int) -> _k_139 (_x_127 - _y_128)))
    | Div (_l_131, _r_130) ->
        _interp_136 _r_130 (fun (_y_132 : int) ->
            _interp_136 _l_131 (fun (_x_133 : int) ->
                match _y_132 with 0 -> ~-1 | _ -> _k_139 (_x_133 / _y_132)))
  in
