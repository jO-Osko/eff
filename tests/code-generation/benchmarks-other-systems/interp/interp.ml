  ...
  handler
    {
      ...
      effect_clauses =
        (fun (type a b) (x : (a, b) effect) : (a -> (b -> _) -> _) ->
          match x with
          | Effect_DivByZero -> fun (() : unit) (_k_30 : int -> _) -> value (-1)
                    ...
                    (fun _x_158 ->
                      _new_special_var_142
                        ( _r_10,
                          fun _lift_fun_330 ->
                            (* value *)
                            (fun _y_159 -> _k_val_141 (_x_158 + _y_159))
                              _lift_fun_330 ))
                      _lift_fun_329 )
          | Mul (_l_14, _r_15) ->
              _new_special_var_142
                    ...
                    (fun _x_173 ->
                      _new_special_var_142
                        ( _r_15,
                          fun _lift_fun_332 ->
                            (* value *)
                            (fun _y_174 -> _k_val_141 (_x_173 * _y_174))
                              _lift_fun_332 ))
                      _lift_fun_331 )
          | Sub (_l_19, _r_20) ->
              _new_special_var_142
                    ...
                    (fun _x_188 ->
                      _new_special_var_142
                        ( _r_20,
                          fun _lift_fun_334 ->
                            (* value *)
                            (fun _y_189 -> _k_val_141 (_x_188 - _y_189))
                              _lift_fun_334 ))
                      _lift_fun_333 )
          | Div (_l_24, _r_25) ->
              _new_special_var_142
                          ...
                          (fun _x_125 ->
                            _new_special_var_119
                              ( _r_123,
                                fun _lift_fun_338 ->
                                  (* value *)
                                  (fun _y_126 -> _k_val_120 (_x_125 + _y_126))
                                    _lift_fun_338 ))
                            _lift_fun_337 )
                | Mul (_l_128, _r_127) ->
                    _new_special_var_119
                          ...
                          (fun _x_129 ->
                            _new_special_var_119
                              ( _r_127,
                                fun _lift_fun_340 ->
                                  (* value *)
                                  (fun _y_130 -> _k_val_120 (_x_129 * _y_130))
                                    _lift_fun_340 ))
                            _lift_fun_339 )
                | Sub (_l_132, _r_131) ->
                    _new_special_var_119
                          ...
                          (fun _x_133 ->
                            _new_special_var_119
                              ( _r_131,
                                fun _lift_fun_342 ->
                                  (* value *)
                                  (fun _y_134 -> _k_val_120 (_x_133 - _y_134))
                                    _lift_fun_342 ))
                            _lift_fun_341 )
                | Div (_l_136, _r_135) ->
                    _new_special_var_119
                              ...
                              ( _l_136,
                                fun _lift_fun_344 ->
                                  ...
                                  (fun _x_138 ->
                                    match _y_137 with
                                    | 0 -> (* ADDED *) value (* ADDED *) (-1)
                                    | _ -> _k_val_120 (_x_138 / _y_137))
                                    _lift_fun_344 ))
                            _lift_fun_343 )
              in
              _new_special_var_119
                ( _r_10,
                  fun _y_139 -> (* ADDED *) value (* ADDED *) (_x_118 + _y_139)
                ) )
    | Mul (_l_14, _r_15) ->
        (fun comp ->
          handler
                    ...
                    | Sub (_l_310, _r_309) ->
                        (fun comp ->
                          ...
                          ( _interp_6 _l_310 >> fun _x_311 ->
                            ...
                            value
                              (let _gen_bind_313 = _var_3 _x_311 in
                    ...
                    | Div (_l_317, _r_316) ->
                        (fun comp ->
                          ...
                          ( _interp_6 _r_316 >> fun _y_318 ->
                            ...
                            | _ ->
                                value
                                  (let _gen_bind_320 = _var_5 _x_319 in
                                   _gen_bind_320 _y_318) )
                  in
                  _new_special_var_296
                    ( _r_15,
                      fun _y_323 ->
                        (* ADDED *) value (* ADDED *) (_x_295 * _y_323) ));
              effect_clauses =
                (fun (type a b) (x : (a, b) effect) : (a -> (b -> _) -> _) ->
                  match x with
                  | Effect_DivByZero ->
                      fun (() : unit) (_k_324 : int -> _) -> value (-1)
                  | eff' -> fun arg k -> Call (eff', arg, k));
            }
            comp)
          (_interp_6 _l_14)
