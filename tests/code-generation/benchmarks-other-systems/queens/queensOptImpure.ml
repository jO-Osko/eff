...
let _queens_one_option_94 _number_of_queens_95 =
  let rec _newvar_17 (_x_14, _qs_13) =
    ...
    | false ->
        ...
        in
        _newvar_35 (run (_available_44 (_number_of_queens_95, _x_14, _qs_13)))
  in
  _newvar_17 (1, [])
              ...
              value (fun _kf_159 ->
                  (run
                     (_newvar_86
                      ...
                      (run (_newvar_112 _xs_63)) _kf_159))
        in
        _newvar_112 (run (_available_44 (_number_of_queens_97, _x_83, _qs_82)))
  in
  (run (_newvar_86 (1, []))) (fun () ->
