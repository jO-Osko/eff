...
let () =
  if run_queens_one then (
    Printf.printf
      "QUEENS ONE OPTION BENCHMARK COMPARISON WITH OTHER SYSTEMS (%d queens):\n"
      number_of_queens;
    Command.run
      (Bench.make_command
         [
           (* Bench.Test.create ~name:"Multicore ocaml" (fun () -> Multicore.queens_one_option number_of_queens); *)
           Bench.Test.create ~name:"Eff directly in ocaml" (fun () ->
               EffInOcaml.queens_one_option number_of_queens);
           Bench.Test.create ~name:"Handlers in action" (fun () ->
               HandlersInAction.queens_one_option number_of_queens);
  ...
  if run_queens_one then (
    Printf.printf
      "QUEENS ONE CPS BENCHMARK COMPARISON WITH OTHER SYSTEMS (%d queens):\n"
      number_of_queens;
    Command.run
      (Bench.make_command
         [
           ...
           Bench.Test.create ~name:"Eff directly in ocaml" (fun () ->
               EffInOcaml.queens_one_cps number_of_queens);
           Bench.Test.create ~name:"Handlers in action" (fun () ->
               HandlersInAction.queens_one_cps number_of_queens);
  ...
  if run_queens_all then (
    Printf.printf
      "QUEENS ALL BENCHMARK COMPARISON WITH OTHER SYSTEMS (%d queens):\n"
      number_of_queens;
    Command.run
      (Bench.make_command
         [
           ...
           Bench.Test.create ~name:"Eff directly in ocaml" (fun () ->
               EffInOcaml.queens_all number_of_queens);
           Bench.Test.create ~name:"Handlers in action" (fun () ->
               HandlersInAction.queens_all number_of_queens);
    ...
    Command.run
      (Bench.make_command
         [
           (* Bench.Test.create ~name:"Multicore ocaml" (fun () -> Multicore.queens_all number_of_queens); *)
           Bench.Test.create ~name:"Eff directly in ocaml" (fun () ->
               EffInOcaml.queens_all 9);
           Bench.Test.create ~name:"Handlers in action" (fun () ->
               HandlersInAction.queens_all 9);
           (* Bench.Test.create ~name:"Generated, impure, not optimized" (fun () -> QueensNoOptImpure._queens_all_100 number_of_queens);
              Bench.Test.create ~name:"Generated, impure, optimized" (fun () -> QueensOptImpure._queens_all_100 number_of_queens);
              Bench.Test.create ~name:"Generated, pure, not optimized" (fun () -> QueensNoOptPure._queens_all_100 number_of_queens); *)
           Bench.Test.create ~name:"Generated, pure, optimized" (fun () ->
               QueensOptPure._queens_all_100 9);
         ]);
    Printf.printf "\n\n");
  if run_queens_all then (
    Printf.printf
    ...
    Command.run
      (Bench.make_command
         [
           (* Bench.Test.create ~name:"Multicore ocaml" (fun () -> Multicore.queens_all number_of_queens); *)
           Bench.Test.create ~name:"Eff directly in ocaml" (fun () ->
               EffInOcaml.queens_all 10);
           Bench.Test.create ~name:"Handlers in action" (fun () ->
               HandlersInAction.queens_all 10);
           (* Bench.Test.create ~name:"Generated, impure, not optimized" (fun () -> QueensNoOptImpure._queens_all_100 number_of_queens);
              Bench.Test.create ~name:"Generated, impure, optimized" (fun () -> QueensOptImpure._queens_all_100 number_of_queens);
              Bench.Test.create ~name:"Generated, pure, not optimized" (fun () -> QueensNoOptPure._queens_all_100 number_of_queens); *)
           Bench.Test.create ~name:"Generated, pure, optimized" (fun () ->
               QueensOptPure._queens_all_100 10);
         ]);
    Printf.printf "\n\n");
  if run_queens_all then (
    Printf.printf
    ...
    Command.run
      (Bench.make_command
         [
           (* Bench.Test.create ~name:"Multicore ocaml" (fun () -> Multicore.queens_all number_of_queens); *)
           Bench.Test.create ~name:"Eff directly in ocaml" (fun () ->
               EffInOcaml.queens_all 11);
           Bench.Test.create ~name:"Handlers in action" (fun () ->
               HandlersInAction.queens_all 11);
           (* Bench.Test.create ~name:"Generated, impure, not optimized" (fun () -> QueensNoOptImpure._queens_all_100 number_of_queens);
              Bench.Test.create ~name:"Generated, impure, optimized" (fun () -> QueensOptImpure._queens_all_100 number_of_queens);
              Bench.Test.create ~name:"Generated, pure, not optimized" (fun () -> QueensNoOptPure._queens_all_100 number_of_queens); *)
           Bench.Test.create ~name:"Generated, pure, optimized" (fun () ->
               QueensOptPure._queens_all_100 11);
         ]);
    Printf.printf "\n\n");
  if run_queens_all then (
    Printf.printf
    ...
    Command.run
      (Bench.make_command
         [
           (* Bench.Test.create ~name:"Multicore ocaml" (fun () -> Multicore.queens_all number_of_queens); *)
           Bench.Test.create ~name:"Eff directly in ocaml" (fun () ->
               EffInOcaml.queens_all 12);
           Bench.Test.create ~name:"Handlers in action" (fun () ->
               HandlersInAction.queens_all 12);
           (* Bench.Test.create ~name:"Generated, impure, not optimized" (fun () -> QueensNoOptImpure._queens_all_100 number_of_queens);
              Bench.Test.create ~name:"Generated, impure, optimized" (fun () -> QueensOptImpure._queens_all_100 number_of_queens);
              Bench.Test.create ~name:"Generated, pure, not optimized" (fun () -> QueensNoOptPure._queens_all_100 number_of_queens); *)
           Bench.Test.create ~name:"Generated, pure, optimized" (fun () ->
               QueensOptPure._queens_all_100 12);
         ]);
    Printf.printf "\n\n");
  if run_queens_all then (
    Printf.printf
    ...
    Command.run
      (Bench.make_command
         [
           (* Bench.Test.create ~name:"Multicore ocaml" (fun () -> Multicore.queens_all number_of_queens); *)
           Bench.Test.create ~name:"Eff directly in ocaml" (fun () ->
               EffInOcaml.queens_all 13);
           Bench.Test.create ~name:"Handlers in action" (fun () ->
               HandlersInAction.queens_all 13);
           (* Bench.Test.create ~name:"Generated, impure, not optimized" (fun () -> QueensNoOptImpure._queens_all_100 number_of_queens);
              Bench.Test.create ~name:"Generated, impure, optimized" (fun () -> QueensOptImpure._queens_all_100 number_of_queens);
              Bench.Test.create ~name:"Generated, pure, not optimized" (fun () -> QueensNoOptPure._queens_all_100 number_of_queens); *)
           Bench.Test.create ~name:"Generated, pure, optimized" (fun () ->
               QueensOptPure._queens_all_100 13);
         ]);
    Printf.printf "\n\n")
