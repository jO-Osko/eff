...
type (_, _) effect += Effect_DivByZero : (unit, int) effect
...
let rec _interp_6 _gen_let_rec_function_7 =
  ...
  | Add (_l_9, _r_10) ->
      ...
      _interp_6 _r_10 >> fun _y_12 -> (run (lift_binary ( + ) _x_11)) _y_12
  | Mul (_l_14, _r_15) ->
      _interp_6 _l_14 >> fun _x_16 ->
      _interp_6 _r_15 >> fun _y_17 -> (run (lift_binary ( * ) _x_16)) _y_17
  | Sub (_l_19, _r_20) ->
      _interp_6 _l_19 >> fun _x_21 ->
      _interp_6 _r_20 >> fun _y_22 -> (run (lift_binary ( - ) _x_21)) _y_22
  | Div (_l_24, _r_25) -> (
      _interp_6 _r_25 >> fun _y_26 ->
      _interp_6 _l_24 >> fun _x_27 ->
      match _y_26 with
      | 0 -> call Effect_DivByZero () (fun _result_2 -> value _result_2)
  ...
  handler
    {
      ...
      effect_clauses =
        (fun (type a b) (x : (a, b) effect) :
          ...
          match x with
          | Effect_DivByZero ->
              fun (() : unit) (_k_30 : int -> _ computation) ->
                lift_unary ( ~- ) 1
                    ...
                    _new_special_var_142
                      ( _l_24,
                        fun _x_216 ->
                          ...
                          | _ ->
                              _k_val_141
                                (run ((run (lift_binary ( / ) _x_216)) _y_215))
                      ) )
        in
        _new_special_var_142
          ( _l_9,
                    ...
                    | Sub (_l_310, _r_309) ->
                        (fun c ->
                          handler
                            {
                              value_clause =
                                (fun _vcvar_314 -> _k_val_297 _vcvar_314);
                              effect_clauses =
                                (fun (type a b) (x : (a, b) effect) :
                                     (a ->
                                     (b -> _ computation) ->
                                  ...
                                  | Effect_DivByZero ->
                                      fun (() : unit)
                                          (_k_315 : int -> _ computation) ->
                                        lift_unary ( ~- ) 1
                                  | eff' -> fun arg k -> Call (eff', arg, k));
                            }
                            c)
                          ( _interp_6 _l_310 >> fun _x_311 ->
                            _interp_6 _r_309 >> fun _y_312 ->
                            _var_3 _x_311 >> fun _gen_bind_313 ->
                    ...
                    | Div (_l_317, _r_316) ->
                        (fun c ->
                          handler
                            {
                              value_clause =
                                (fun _vcvar_321 -> _k_val_297 _vcvar_321);
                              effect_clauses =
                                (fun (type a b) (x : (a, b) effect) :
                                     (a ->
                                     (b -> _ computation) ->
                                  ...
                                  | Effect_DivByZero ->
                                      fun (() : unit)
                                          (_k_322 : int -> _ computation) ->
                                        lift_unary ( ~- ) 1
                                  | eff' -> fun arg k -> Call (eff', arg, k));
                            }
                            c)
                          ( _interp_6 _r_316 >> fun _y_318 ->
                            _interp_6 _l_317 >> fun _x_319 ->
                            match _y_318 with
                            | 0 -> (effect Effect_DivByZero) ()
                            | _ ->
                                _var_5 _x_319 >> fun _gen_bind_320 ->
                                _gen_bind_320 _y_318 )
                  in
                  _new_special_var_296
                    ( _r_15,
                      fun _y_323 ->
                        value (run ((run (lift_binary ( * ) _x_295)) _y_323)) ));
              effect_clauses =
                (fun (type a b) (x : (a, b) effect) :
                     (a -> (b -> _ computation) -> _ computation) ->
                  match x with
                  | Effect_DivByZero ->
                      fun (() : unit) (_k_324 : int -> _ computation) ->
                        lift_unary ( ~- ) 1
                  | eff' -> fun arg k -> Call (eff', arg, k));
            }
            c)
          ...
          handler
            {
              ...
              effect_clauses =
                (fun (type a b) (x : (a, b) effect) :
                  ...
                  match x with
                  | Effect_DivByZero ->
                      fun (() : unit) (_k_326 : int -> _ computation) ->
                        lift_unary ( ~- ) 1
                  | eff' -> fun arg k -> Call (eff', arg, k));
            }
            c)
          ( _interp_6 _l_19 >> fun _x_21 ->
            _interp_6 _r_20 >> fun _y_22 ->
            (run (lift_binary ( - ) _x_21)) _y_22 )
    | Div (_l_24, _r_25) ->
        (fun c ->
          handler
            {
              ...
              effect_clauses =
                (fun (type a b) (x : (a, b) effect) :
                  ...
                  match x with
                  | Effect_DivByZero ->
                      fun (() : unit) (_k_328 : int -> _ computation) ->
                        lift_unary ( ~- ) 1
                  | eff' -> fun arg k -> Call (eff', arg, k));
            }
            c)
          ( _interp_6 _r_25 >> fun _y_26 ->
            _interp_6 _l_24 >> fun _x_27 ->
            match _y_26 with
            | 0 -> call Effect_DivByZero () (fun _result_7 -> value _result_7)
            | _ -> (run (lift_binary ( / ) _x_27)) _y_26 )
  in
