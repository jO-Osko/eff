...
let rec _interp_6 _gen_let_rec_function_7 =
  ...
  | Add (_l_9, _r_10) ->
      ...
      _interp_6 _r_10 >> fun _y_12 ->
      value
        (let _gen_bind_13 = _var_1 _x_11 in
         _gen_bind_13 _y_12)
  | Mul (_l_14, _r_15) ->
      _interp_6 _l_14 >> fun _x_16 ->
      _interp_6 _r_15 >> fun _y_17 ->
      value
        (let _gen_bind_18 = _var_2 _x_16 in
         _gen_bind_18 _y_17)
  | Sub (_l_19, _r_20) ->
      _interp_6 _l_19 >> fun _x_21 ->
      _interp_6 _r_20 >> fun _y_22 ->
      value
        (let _gen_bind_23 = _var_3 _x_21 in
         _gen_bind_23 _y_22)
  | Div (_l_24, _r_25) -> (
  ...
  handler
    {
      ...
      effect_clauses =
        (fun (type a b) (x : (a, b) effect) : (a -> (b -> _) -> _) ->
          match x with
          | Effect_DivByZero ->
              fun (() : unit) (_k_30 : int -> _) -> value (_var_4 1)
...
let rec _createCase_32 _n_33 =
  ...
  | _ ->
      let _gen_bind_34 =
        let _gen_bind_35 =
          let _gen_bind_36 = _var_3 _n_33 in
          _gen_bind_36 1
        in
        _createCase_32 _gen_bind_35
      in
...
let _bigTest_38 () =
  _arithmeticHandler_29
    (let _gen_bind_39 = _createCase_32 200 in
     _interp_6 _gen_bind_39)
